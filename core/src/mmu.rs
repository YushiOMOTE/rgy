...
impl Mmu {
    ...
    fn io_read(&self, addr: u16) -> u8 {
        match addr {
            ...
            0xff10 => self.sound.read_tone_sweep(),
            0xff11 => self.sound.read_tone_wave(0),
            0xff12 => self.sound.read_tone_envelop(0),
            0xff13 => self.sound.read_tone_freq_low(0),
            0xff14 => self.sound.read_tone_freq_high(0),
            0xff16 => self.sound.read_tone_wave(1),
            0xff17 => self.sound.read_tone_envelop(1),
            0xff18 => self.sound.read_tone_freq_low(1),
            0xff19 => self.sound.read_tone_freq_high(1),
            0xff1a => self.sound.read_wave_enable(),
            0xff1b => self.sound.read_wave_len(),
            0xff1c => self.sound.read_wave_amp(),
            0xff1d => self.sound.read_wave_freq_low(),
            0xff1e => self.sound.read_wave_freq_high(),
            0xff20 => self.sound.read_noise_len(),
            0xff21 => self.sound.read_noise_envelop(),
            0xff22 => self.sound.read_noise_poly_counter(),
            0xff23 => self.sound.read_noise_select(),
            0xff24 => self.sound.read_ctrl(),
            0xff25 => self.sound.read_so_mask(),
            0xff26 => self.sound.read_enable(),
            0xff30..=0xff3f => self.sound.read_wave_buf(addr),
    ...
    fn io_write(&mut self, addr: u16, v: u8) {
        match addr {
            ...
            0xff10 => self.sound.write_tone_sweep(v),
            0xff11 => self.sound.write_tone_wave(0, v),
            0xff12 => self.sound.write_tone_envelop(0, v),
            0xff13 => self.sound.write_tone_freq_low(0, v),
            0xff14 => self.sound.write_tone_freq_high(0, v),
            0xff16 => self.sound.write_tone_wave(1, v),
            0xff17 => self.sound.write_tone_envelop(1, v),
            0xff18 => self.sound.write_tone_freq_low(1, v),
            0xff19 => self.sound.write_tone_freq_high(1, v),
            0xff1a => self.sound.write_wave_enable(v),
            0xff1b => self.sound.write_wave_len(v),
            0xff1c => self.sound.write_wave_amp(v),
            0xff1d => self.sound.write_wave_freq_low(v),
            0xff1e => self.sound.write_wave_freq_high(v),
            0xff20 => self.sound.write_noise_len(v),
            0xff21 => self.sound.write_noise_envelop(v),
            0xff22 => self.sound.write_noise_poly_counter(v),
            0xff23 => self.sound.write_noise_select(v),
            0xff24 => self.sound.write_ctrl(v),
            0xff25 => self.sound.write_so_mask(v),
            0xff26 => self.sound.write_enable(v),
            0xff30..=0xff3f => self.sound.write_wave_buf(addr, v),
